...
//        InsertSym(LABEL, "Done", "", "", 0, 0);
    ...
    private void ExtractStmt (AST ast, String context, String cType) {
        ...
        *******************************************************************/
            ...
            ExtractMaybeFail((AST.MaybeFail) ast, context, cType);
...
// detected.
    ...
    ***********************************************************************/
    ...
    private void ExtractReceiveCall(AST.ReceiveCall ast, String context, String cType) {
    }
    ...
    private void ExtractMaybeFail(AST.MaybeFail ast, String context, String cType) {
    }
