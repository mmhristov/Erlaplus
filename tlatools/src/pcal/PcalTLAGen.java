    ...
    ***************************************************************************/
    ...
    private void GenStmt(AST ast, Changed c, String context, String prefix, int col) throws PcalTLAGenException
    {
        ...
        // Either case added by LL on 27 Jan 2006
            ...
            GenMaybeFail((AST.MaybeFail) ast, c, context, prefix, col);
        else
...
/* -------------------------------------------------------------------------- */
    ...
    private void GenSendCall(AST.SendCall ast, Changed c, String context, String prefix, int col) throws PcalTLAGenException {
        try {
            ...
            endCurrentLineOfTLA();
        } catch (TLAExprException | ParseAlgorithmException e) {
            throw new PcalTLAGenException("Encountered exception while generating send operation");
        }
    }
    ...
    private void GenFail(AST.Fail ast, Changed c, String context, String prefix, int col) throws PcalTLAGenException {
        GenWhen(ast.await, c, context, prefix, col);
    }

    private void GenMaybeFail(AST.MaybeFail ast, Changed c, String context, String prefix, int col) throws PcalTLAGenException {
        GenEither(ast.either, c, context, prefix, col);
    }
}
