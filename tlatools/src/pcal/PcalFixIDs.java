...
public class PcalFixIDs {
    ...
    private static void FixSym (AST ast, String context) throws PcalFixIDException {
        ...
        *******************************************************************/
            ...
            FixMaybeFail((AST.MaybeFail) ast, context);
        else PcalDebug.ReportBug("Unexpected AST type" + ast.toString());
    }

    private static void FixMaybeFail(AST.MaybeFail ast, String context) {
    }

    private static void FixFail(AST.Fail ast, String context) {
    }

    private static void FixReceiveCall(AST.ReceiveCall ast, String context) throws PcalFixIDException {
